...
\begin{split}
& \lt|\pinv{V_\loc} c_\loc\rt|\leq s^\pr_\loc~~\lt(i.e.,~\Rightarrow
...
\tbf{Choosing the primary template.}  We should ensure that the primary template has full rank, so that the the pseudo-inverse is defined. Ensuring this, we may collect all or some of
