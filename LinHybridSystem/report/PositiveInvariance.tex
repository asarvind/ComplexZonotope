...
%% approach is to fix the template vectors of the augmented complex
%% zonotope and solve for remaining variables to get a positive
%% invariant.  Some aspects of the hybrid system specification, like the
%% eigenstructure of affine maps, directions for the linear guards and
%% staying conditions, etc. provide guidance for choosing the template
%% vectors.  We shall discuss the approach to choosing a template in a
%% latter section.  In this section, we derive sufficient conditions for
%% finding a positively invariant augmented complex zonotope, given fixed
%% primary and secondary templates.  
Our goal is to compute positively invariant augmented complex
