We introduce an augmented complex zonotope, which is a slightly more
general set representation than a template complex zonotope.  An
augmented complex zonotope is the Minkowski sum of a template complex
zonotope and a real zonotope.  Geometrically, the sets that can be
described as real projections of augmented complex zonotopes can also
be described as real projections of template complex zonotopes.  But
...
see latter.  Threfore, it will be more convenient to derive conditions
for positive invariance based on augmented complex zonotopes.
%
