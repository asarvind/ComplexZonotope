...
\begin{frame}{Experiment: Networked vehicle platoon}
\begin{minipage}{1\textwidth}
\begin{minipage}{0.7\textwidth}
{\flushleft \includegraphics[scale=0.35]{fig/VehiclePlatoon.png}}
\end{minipage}
\begin{minipage}{0.29\textwidth}
{\small {\color{blue} Benchmark 2014 ARCH Workshop~\cite{makhlouf2014networked}}}
\end{minipage}
\end{minipage}
\begin{table}
...
\hline
\multicolumn{2}{|c|}{\multirow{4}{*}{Method}} & \multicolumn{4}{|c|}{{Fast switching:}}\\
\multicolumn{2}{|c|}{}  & \multicolumn{4}{|c|}{Integer dwell times} \\
\cline{3-6}
...
& vectors & & & &\\
\hline
\multicolumn{2}{|c|}{\multirow{2}{*}{TCZ invariant}} &
...
{\tiny{\center \hspace{6em} UB: $>$1000, ~~NT: Not terminating in more than 180s, \newline
  n/a: Not applicable/not available, ~~TCZ: Tempalte complex
  zonotope.}}
\end{table}
\end{frame}
