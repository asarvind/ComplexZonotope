...
\begin{itemize}
\item Saturated: 9 dimensional, 1 location, 9 edges.
\item Unsaturated: 9 dimensional linear system.
\end{itemize}
\end{block}
\end{frame}

\begin{frame}{Experimental settings: NXT-Lego Robot model}
...
\center{{\eqncol{\footnotesize UB: $>$1000, ~~NT: Not terminating in more than 180s, \newline
