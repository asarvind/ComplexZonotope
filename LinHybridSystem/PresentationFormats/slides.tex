...
\end{itemize}
\pause
\item \textcol{Efficient computation/approximation of system operations}, like \emph{Minkowski sum, linear transformation}, etc.\\
\pause
{\color{brown} For example}
\begin{itemize}
...
\begin{enumerate}
\item \textcol{Efficient invariant computation} based on eigenstructure.
\item \textcol{Closure} under \eqncol{Linear transformation and Minkowski sum}.
\end{enumerate}
