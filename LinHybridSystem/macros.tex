...
\newcommand{\locationset}{\mb{L}}
\newcommand{\edgeset}{\mb{E}}
\newcommand{\stay}{\mb{S}}
\newcommand{\linearmapset}{\mb{A}}
\newcommand{\inputset}{\mb{U}}
\newcommand{\initialset}{\Omega}
\newcommand{\edge}{\sigma}
\newcommand{\loc}{\mu}
\newcommand{\map}{\linearmapset}
\newcommand{\inp}{\inputset}
\newcommand{\ptemplate}{\mb{K}}
\newcommand{\systrj}[3]{\lt(\tbf{#1},\tbf{#2}\rt)\lt(#3\rt)}
