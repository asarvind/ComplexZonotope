...
Minkowski sum operations.  The resultant interval zonotopes can be
computed as affine functions of the parameters of the original
interval zonotopes, as stated in the following two lemmas.
%
\begin{lemma}[Linear transformation]
