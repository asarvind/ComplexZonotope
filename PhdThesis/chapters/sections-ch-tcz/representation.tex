...
\end{definition}
%
{\it Geometry of a complex zonotope :} The real projection of a complex
...
system will be a positively invariant if the complex eigenvalues
...
\begin{figure}
\center
\includegraphics[scale=0.5]{fig/CZtopes/eigcontraction.png}
