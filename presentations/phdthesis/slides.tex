...
\begin{minipage}{0.55\textwidth}
\begin{enumerate}
\item \plemph{Continuous linear evolution} with intermediate \plemph{ linear impulses}.
\item \plemph{Time} between \plemph{succesive impulses} is \plemph{bounded} in a \plemph{sampling interval}.
\end{enumerate}
\end{minipage}
%
\begin{minipage}{0.4\textwidth}
