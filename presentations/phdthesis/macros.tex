...
%%% Compatibility with other tex files while copying
\newcommand{\eqncol}{\eqnemph}
\newcommand{\textcol}{\plemph}
...
%%% Emphasizing
%%======================================================
\newcommand{\negemph}[1]{{\color{alizarin} #1}}
%\newcommand{\posemph}[1]{{\color{forestgreen(web)}#1}}
\newcommand{\posemph}[1]{{\color{ceruleanblue}#1}}
\newcommand{\plemph}[1]{{\color{blue}#1}}
\newcommand{\eqnemph}[1]{{\color{byzantium}#1}}
